...
boolean isIpRepeat=adao.isIpRepeate(sid, request.getRemoteAddr());
...
<title><%=cfg.getCSiteName() %>---问卷查看---<%=survey.getSName() %></title>
...
<div id="head1">
 <img src="images/top.jpg" width="768" height="90" style="border:0px;">
</div>
<%
//密码校验
