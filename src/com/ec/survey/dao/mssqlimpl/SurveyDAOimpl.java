...
public class SurveyDAOimpl implements SurveyDAO{
	...
	public boolean delSurvey(Long surveyId) {
		 ...
		 return -1!=cmd.executeSQL("delete from survey where s_id="+surveyId);
	...
	public boolean updateSurvey(Survey survey) {
		...
		try {
			...
			//pstmt.setString(4, survey.getSAuthor());
			//pstmt.setString(5, survey.getSImg());
			//pstmt.setBoolean(1, survey.getSIpRepeat());
			//pstmt.setDate(2, new java.sql.Date(survey.getSCreateDate().getTime()));
			//pstmt.setString(8, survey.getSIpLimitType());
			//pstmt.setString(9, survey.getSIpRange());
			//pstmt.setString(10, survey.getSPassword());
			//pstmt.setBoolean(3, survey.getSIsOpen());
			//pstmt.setDate(4, new java.sql.Date(survey.getSExpireDate().getTime()));
			//pstmt.setBoolean(5, survey.getSIsAudited());
			//pstmt.setLong(6, survey.getSHits());
			//pstmt.setLong(7, survey.getSUsehits());
			//pstmt.setLong(8, survey.getSId());
